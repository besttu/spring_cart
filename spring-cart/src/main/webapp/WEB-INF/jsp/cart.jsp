	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		           <c:choose>
		               ...
		               <div class="cell p-checkbox"><input data-bind="cbid:1" checked="checked" itemId="${cart.id}"  class="checkbox" type="checkbox" name="checkItem" value="${cart.id}"></div>
		           </c:when>
		           <c:otherwise>
		             <div class="cell p-checkbox">
		             <input data-bind="cbid:1" class="checkbox" type="checkbox"  name="checkItem"  value="${cart.id}">
		             </div>
		           </c:otherwise>
		           </c:choose>
